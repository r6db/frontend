...
const ModeStats = {
    view({ attrs }) {
        return (
            <div className="player-module-content mode">
...
export default {
    view({ attrs }) {
        return (
            <div className="player-module gamemodes">
                <div className="player-module-header">Bomb</div>
                <div className="player-module-content mode">
                ...
                <div className="player-module-header">Secure Area</div>
                <div className="player-module-content mode">
                ...
                <div className="player-module-header">Hostage</div>
                <div className="player-module-content mode">
