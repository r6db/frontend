        ...
        <div className="playermodule statoverview">
            ...
            <div className="row">
                <div className="col">
                    ...
                    <Stat label="win rate">{getWinChance(props.stats.general)}</Stat>
                ...
                <div className="col">
                    ...
                    <Stat label="hs / kills">{get(props, "stats.general.headshotRatio", 0).toFixed(2)}%</Stat>
                    <Stat label="hs / hits">{get(props, "stats.general.headshotChance", 0).toFixed(2)}%</Stat>
                </div>
            </div>
            ...
            <div className="row">
                ...
                <div className="col">
                    <Stat label="pen. kills">{get(props, "stats.general.penetrationKills", 0)}</Stat>
