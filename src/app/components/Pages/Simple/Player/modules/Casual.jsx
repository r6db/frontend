    ...
    view: ({ attrs }) =>
        attrs.player.stats != null ? (
            <div className="profile-casualstats card">
                <header className="card__header">Casual Stats</header>
                <div className="card__content">
                    ...
                    <div className="row">
                        ...
                        <div className="value">{getWL(attrs.player.stats.casual)}%</div>
                    </div>
                    <div className="row">
                    ...
                    <div className="row">
                        ...
                        <div className="value">{getKD(attrs.player.stats.casual)}</div>
                    </div>
                </div>
            </div>
        ) : (
