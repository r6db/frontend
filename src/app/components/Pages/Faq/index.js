        ...
        return (
            <div className="faq">
                <Question question="What is 'skill' and 'uncertainty', and now is it related to the leaderboard?">
                    ...
                    <p>
                        Because such system can't be perfect, another variable exists: <i>uncertainty</i>. As the name suggests, uncertainty models how accurate your skill-rating is. As you play, the uncertainty value constantly falls and approaches zero: "Perfect accuracy". The Points you see in-game is called the mmr (or MatchMaking Rating). This value is calculated from your skill-rating and up until Red Crow also took your playtime into consideration. <br/>

                        As a rule of thumb: <em>"skill on leaderboard" = skill-rating - uncertainty</em>.
                   </p>
                    <p>
                        ...
                        <blockquote>
                            ...
                            We even managed to bring on of our mates up to a 54 win-rate (thats 98%). 
                ...
                <Question question="I searched for my name, but it says that I haven't played the game yet.">
                    <p>
                        this Error can be triggered in multiple ways:  
                        <ul>
                            <li>we didn't grab your data yet. Try again in a few minutes</li>
                            <li>you're looking on the wrong patform (see links in the top of the menu)</li>
                ...
                <Question question="I want to develop my own stuff with r6db data. Do you guys have an API?">
                    <p>
                        ...
                        <em>Just to make it clear: We do and can NOT give any guarantee about uptime and availability.</em> While NaugtyMuppet does give his best, it is still a hobby project.
                    </p>
                </Question>
