        ...
        return m(".footer", [
            m(".footer__container.container", [
                ...
                m(".footer__column", [
                    ...
                    m("a", { target: "_BLANK", rel:"noopener", className: "footer__link", href: "https://twitter.com/Rainbow6_DB"}, [
                        m(Icon, { className: "footer__icon", glyph: GLYPHS.TWITTER }),
                        "Twitter"
                    ]),
                    ...
                    m("a", { target: "_BLANK", rel:"noopener", className: "footer__link", href: "https://discord.gg/xyMTkXm" }, [
                        m(Icon, { className: "footer__icon", glyph: GLYPHS.DISCORD }),
                        "Discord"
                    ]),
                    m("a", { target: "_BLANK", rel:"noopener", className: "footer__link footer__link--noicon", href: "https://github.com/r6db"}, "Github"),
                ]),
                m(".footer__column", [
                    m("header.footer__header", ""),
                    ...
                    m("a", { className: "footer__link footer__link--noicon", href: "https://github.com/r6db/r6db/issues"}, "Report bug"),
                ]),
            ])
        ])
    }
