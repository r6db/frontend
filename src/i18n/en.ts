export default {
    ...
    "favorites/addmore":
        "You can add more people by clicking the 'Favorite' button on the player page!",
    ...
    "delete/step1_instruction":
        "To start the deletion process, please enter your full R6DB profile URL down below.",
    ...
    "delete/step3_instruction":
        "Before you deactivate your account, know this:",
    "delete/step3_noreadd":
        "Deletion is <b>FINAL</b> and <b>CANNOT</b> be undone.",
    ...
    "delete/step3_blacklist":
        "Your account will be added to a blacklist to prevent future fetching of your data.",
